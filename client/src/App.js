        ...
        <div className="card text-center">
          ...
          <div className="card-body">
            <div className="input-group mb-3">
              ...
              className="form-control" placeholder="Ingrese nombre" aria-label="Nombre de usuario" aria-describedby="basic-addon1"/>
            </div>
            ...
            <div className="input-group mb-3">
              ...
              className="form-control" placeholder="Ingrese pais" aria-label="Pais" aria-describedby="basic-addon1"/>
            </div>
